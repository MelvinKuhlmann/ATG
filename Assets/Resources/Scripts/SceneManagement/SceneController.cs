...
public class SceneController : MonoBehaviour
    {
      ...
      //      m_PlayerInput = FindObjectOfType<PlayerInput>();
        ...
        public static void TransitionToScene(string newSceneName, bool resetInputValuesOnTransition, SceneTransitionDestination.DestinationTag transitionDestinationTag, TransitionType transitionType)
        {
            Instance.StartCoroutine(Instance.Transition(newSceneName, resetInputValuesOnTransition, transitionDestinationTag, transitionType));
        }
